...
class PianoTranscription(object):
    def __init__(self, model_type='Note_pedal', checkpoint_path=None, 
        segment_samples=16000*10, device=torch.device('cuda'), batch_size = 2, onset_threshold = 0.3, offset_threshod = 0.3, frame_threshold = 0.1, pedal_offset_threshold = 0.2):
        ...
        self.offset_threshod = offset_threshod
